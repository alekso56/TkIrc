...
public class Base64
{
  ...
  public static String encode(String string)
  {
    ...
    for (int i = 0; i < stringArray.length; i += 3) {
      ...
      encoded = encoded + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(j >> 18 & 0x3F) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(j >> 12 & 0x3F) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(j >> 6 & 0x3F) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(j & 0x3F);
    }
